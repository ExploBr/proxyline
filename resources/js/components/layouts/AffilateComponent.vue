...
<div  >
    <div class="count__usd count__item" v-scroll="handleScroll">
        <span class="numbers numbers-dollar" style="opacity: 1"><vue3-autocounter ref='counter' :startAmount="0" :endAmount="939269" :duration="4" separator="." :autoinit="false"></vue3-autocounter></span>
    ...
    <div class="count__rub count__item">
        ...
        <span class="numbers numbers-rub"> <vue3-autocounter ref='counter2' :startAmount="0" :endAmount="78902353"  :duration="4" separator="." :autoinit="false"></vue3-autocounter></span>
